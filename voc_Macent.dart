...
class MyApp extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: multiMacent(this.text,this.audioPlayer,this.audioCache),
    );
  }

}
class multiMacent extends StatefulWidget{
  String text;
  multiMacent(this.text,this.audioPlayer,this.audioCache);
  AudioPlayer audioPlayer;
  AudioCache audioCache;
  @override
...
class leter extends State<multiMacent>{
  AudioPlayer audioPlayer;
  AudioCache audioCache;
  List _salidas;
  File _Imagen;
  ...
  loadModel() async{
    await Tflite.loadModel(model: "assets/model_unquantMayu.tflite",
        labels: "assets/labelsMacent.txt"
    );
  }
  @override
  void dispose(){
