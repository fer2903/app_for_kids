...
class MyApp extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: multiMayus(this.text,this.audioPlayer,this.audioCache),
    );
  }

}
class multiMayus extends StatefulWidget{
  String text;
  multiMayus(this.text,this.audioPlayer,this.audioCache);
  AudioPlayer audioPlayer;
  AudioCache audioCache;
  @override
...
class leter extends State<multiMayus>{
  AudioPlayer audioPlayer;
  AudioCache audioCache;
  List _salidas;
  File _Imagen;
