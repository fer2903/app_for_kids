...
class MyApp extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: ooo(this.text,this.audioPlayer,this.audioCache),
    );
  }
...
class ooo extends StatefulWidget{
  String text;
  ooo(this.text,this.audioPlayer,this.audioCache);
  AudioPlayer audioPlayer;
  AudioCache audioCache;
  @override
...
class leter extends State<ooo>{
  ...
  loadModel() async{
    await Tflite.loadModel(model: "assets/model_unquantOO.tflite",
        labels: "assets/labelsOO.txt"
    );
  }
  @override
  void dispose(){
