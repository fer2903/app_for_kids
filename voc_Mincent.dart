...
class MyApp extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: multiMincent(this.text,this.audioPlayer,this.audioCache),
    );
  }

}
class multiMincent extends StatefulWidget{
  String text;
  multiMincent(this.text,this.audioPlayer,this.audioCache);
  AudioPlayer audioPlayer;
  AudioCache audioCache;
  @override
...
class leter extends State<multiMincent>{
  AudioPlayer audioPlayer;
  AudioCache audioCache;
  List _salidas;
  File _Imagen;
  ...
  loadModel() async{
    await Tflite.loadModel(model: "assets/model_unquantminus.tflite",
        labels: "assets/labelsMincent.txt"
    );
  }
  @override
  void dispose(){
